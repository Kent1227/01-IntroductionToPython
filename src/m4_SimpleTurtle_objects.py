...
natasha.pen = rg.Pen('red', 10)  # Second argument is the Pen's thickness
natasha.speed = 5  # Bigger means faster, max is usually about 10

natasha.backward(50)
natasha.right(90)
natasha.pen = rg.Pen('midnight blue', 10)
natasha.forward(125)
...
boris.go_to(rg.Point(natasha.x_cor(), natasha.y_cor()))
...
#
###############################################################################
edward = rg.SimpleTurtle()

edward.left(180)
edward.pen = rg.Pen('purple', 10)
edward.forward(50)
print(math.atan((boris.x_cor() - edward.x_cor()) / (boris.y_cor() - edward.y_cor())))
edward.set_heading(90 + math.fabs(((180 / 3.1415) * (math.atan((boris.x_cor() - edward.x_cor()) / (boris.y_cor() - edward.y_cor()))))))
edward.forward(math.sqrt(((boris.x_cor() - edward.x_cor()) ** 2) + ((boris.y_cor() - edward.y_cor()) ** 2)))
###############################################################################
#
# DONE: 6.
